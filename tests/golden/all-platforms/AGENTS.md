...
This is a [Spectrum](https://photon.codes/docs/spectrum-ts) app, pinned to `spectrum-ts@^1.2.3`. The entry point is `src/index.ts`, which configures the iMessage, WhatsApp Business provider(s) and runs the echo loop.
